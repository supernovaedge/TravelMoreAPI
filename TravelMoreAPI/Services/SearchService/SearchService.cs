...
namespace TravelMoreAPI.Services
{
    public class SearchService : ISearchService
    {
        ...
        public List<Apartment> GetApartments(SearchCriteriaDto searchCriteria)
        {
            ...
            {
                if (searchCriteria.StartDate.Value.Date <= bookingEntity.HostTo.Date && bookingEntity.HostFrom.Date <= searchCriteria.EndDate.Value.Date && bookingEntity.CurrentStatus == GuestStatus.GuestStatusEnum.Accepted)
                {
